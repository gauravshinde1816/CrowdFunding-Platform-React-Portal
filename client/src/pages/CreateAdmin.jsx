...
import { USER_TYPE_ADMIN } from "../config/Constants";
...
const CreateAdmin = ({ setUserByToken }) => {
  ...
  const onFinish = (values) => {
    values = { ...values, role: USER_TYPE_ADMIN };
    console.log(values);
  ...
  return (
    <div className="text-center space-y-2 mt-40">
      <h1 className=" text-4xl font-bold mb-10">Create Admin</h1>
      <Form
